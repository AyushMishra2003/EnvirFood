  ...
  return (
    <div className='lg:pt-[3rem] p-[1rem] lg:p-[2rem] flex flex-col gap-[1rem] lg:items-center justify-center '>
        <div className='flex flex-col '>
            ...
            <div className='flex flex-col lg:flex-row lg:gap-[24rem] lg:justify-center lg:items-center md:gap-9  md:flex-row  md:justify-between xl:gap-[42rem] md:gap-2 '>
            <h1 className='font-bold text-[1.5rem] md:text-[1.5rem]'>Let's checkout Our Latests Research</h1>
            <Link to={"/coming"}>
