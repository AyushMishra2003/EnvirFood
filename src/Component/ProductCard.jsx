...
const ProductCard = ({image,text,To}) => {
  return (
    <div className='flex flex-col items-center justify-center '>
       ...
       <div className=' lg:w-[20rem] w-[10rem]  flex flex-col items-center  p-[1rem] rounded-[0.5rem] bg-[#FFFFFFF] absolute  cursor-pointer hover:bg-[#FF8E00]  bg-[#bfc2b8] bottom-[3rem] '>
