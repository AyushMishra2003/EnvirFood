...
const AboutUsPage = () => {
  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <div className='flex flex-wrap lg:flex-row items-center justify-center  gap-[6rem] rounded-[0.3rem] p-[2rem]  shadow-[3px_7px_3px_#596d91] w-[100vw] '>
      <div className='flex flex-col lg:flex-row items-center  gap-[5rem] bg-[#EBEAF0] p-[3rem] md:flex-row '>
        <div className='flex flex-col gap-[2rem] items-center w-[20rem] '>
          ...
          <div className='md:text-[1rem] text-[1.4rem] font-normal sm:text-[1.9rem]'>
        ...
        <div className='flex flex-col items-center gap-[2rem]  w-[20rem]'>
          ...
          <div className='md:text-[1rem] text-[1.4rem] font-normal sm:text-[1.9rem]  p-[1.5rem]'>
